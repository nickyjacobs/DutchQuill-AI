...
Het script schoont automatisch documentmetadata op zodat het .docx-bestand niet herleidbaar is naar python-docx of automatische generatie:

| Veld | python-docx default | Na opschoning |
|------|---------------------|---------------|
| `AppVersion` | 14.0000 (Word 2011) | 16.0000 (Word 365/2021) |
| `TotalTime` | 0 minuten | 15–90 minuten (variabel) |
| `Author` | "python-docx" | Studentnaam uit metadata |
| `Description` | "generated by python-docx" | Leeg |
| `Revision` | 1 | 8–25 (variabel) |
| `Created/Modified` | Identieke timestamps | Realistische offset |

Zie [metadata-opschoning.md](metadata-opschoning.md) voor de achtergrond en detectietools.
...
De PDF-metadata bevat geen verwijzingen naar DutchQuill AI of ReportLab:

| Veld | Eerder | Na opschoning |
|------|--------|---------------|
| `Author` | "DutchQuill AI" | Leeg |
| `Creator` | "ReportLab" | Leeg |
| `Producer` | "ReportLab PDF Library" | Leeg |
| `Title` | "... — DutchQuill AI" | Alleen de rapporttitel |

De visible footer in het rapport ("Gegenereerd door DutchQuill AI") blijft ongewijzigd — dit zijn interne rapporten die niet worden ingeleverd.
